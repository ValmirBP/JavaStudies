  ...
  public static void main(String[] args) {
    try (Scanner s = new Scanner(System.in)) {
      ...
      do {
        ...
        if (civilState.equalsIgnoreCase("S")
            || civilState.equalsIgnoreCase("C")
            || civilState.equalsIgnoreCase("V")
            || civilState.equalsIgnoreCase("D")) {
          ...
          System.out.println(
              " Estado civil deve ser Solteiro (S) ou Casado (C)" + " Viuvo (V) ou Divorciado (D)");
        }
      } while (!valid);
